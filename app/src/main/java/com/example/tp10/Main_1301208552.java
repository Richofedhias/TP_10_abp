...
public class Main_1301208552 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_1301208552);
    ...
    private void DialogForm() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Main_1301208552.this);
